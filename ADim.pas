...
{ Unit of KilogramMeter }

type
  TKilogramMeterUnit = class(TUnit)
    class function Name: string; override;
    class function Symbol: string; override;
  end;
  TKilogramMeterIdentifier = specialize TQuantityIdentifier<TKilogramMeterUnit>;
  TKilogramsMeter = specialize TQuantity<TKilogramMeterUnit>;
...
{ Unit of AmpereSquareMeter }

type
  TAmpereSquareMeterUnit = class(TUnit)
    class function Name: string; override;
    class function Symbol: string; override;
  end;
  TAmpereSquareMeterIdentifier = specialize TQuantityIdentifier<TAmpereSquareMeterUnit>;
  TAmperesSquareMeter = specialize TQuantity<TAmpereSquareMeterUnit>;

var
  Am2: TAmpereSquareMeterIdentifier;
...
operator *(const {%H-}ALeft: TKilogramIdentifier; const {%H-}ARight: TMeterIdentifier): TKilogramMeterIdentifier; inline;
operator /(const {%H-}ALeft: TKilogramMeterIdentifier; const {%H-}ARight: TKilogramIdentifier): TMeterIdentifier; inline;
operator *(const {%H-}ALeft: TMeterIdentifier; const {%H-}ARight: TKilogramIdentifier): TKilogramMeterIdentifier; inline;
operator /(const {%H-}ALeft: TKilogramMeterIdentifier; const {%H-}ARight: TMeterIdentifier): TKilogramIdentifier; inline;
...
// alternative definition [ kg*m2 ] = [ kg*m ] * [ m ]
operator *(const {%H-}ALeft: TKilogramMeterIdentifier; const {%H-}ARight: TMeterIdentifier): TKilogramSquareMeterIdentifier; inline;
operator /(const {%H-}ALeft: TKilogramSquareMeterIdentifier; const {%H-}ARight: TKilogramMeterIdentifier): TMeterIdentifier; inline;
operator *(const {%H-}ALeft: TMeterIdentifier; const {%H-}ARight: TKilogramMeterIdentifier): TKilogramSquareMeterIdentifier; inline;
operator /(const {%H-}ALeft: TKilogramSquareMeterIdentifier; const {%H-}ARight: TMeterIdentifier): TKilogramMeterIdentifier; inline;

// alternative definition [ kg*m2 ] = [ J ] / [ rad2/s2 ]
...
// main definition [ N*m ] = [ kg*m2 ] * [ rad/s2 ]
operator *(const {%H-}ALeft: TKilogramSquareMeterIdentifier; const {%H-}ARight: TRadianPerSquareSecondIdentifier): TNewtonMeterIdentifier; inline;
operator /(const {%H-}ALeft: TNewtonMeterIdentifier; const {%H-}ARight: TKilogramSquareMeterIdentifier): TRadianPerSquareSecondIdentifier; inline;
operator *(const {%H-}ALeft: TRadianPerSquareSecondIdentifier; const {%H-}ARight: TKilogramSquareMeterIdentifier): TNewtonMeterIdentifier; inline;
operator /(const {%H-}ALeft: TNewtonMeterIdentifier; const {%H-}ARight: TRadianPerSquareSecondIdentifier): TKilogramSquareMeterIdentifier; inline;
...
// main definition [ kg*m2/s ] = [ kg*m/s ] * [ m ]
operator *(const {%H-}ALeft: TKilogramMeterPerSecondIdentifier; const {%H-}ARight: TMeterIdentifier): TKilogramSquareMeterPerSecondIdentifier; inline;
operator /(const {%H-}ALeft: TKilogramSquareMeterPerSecondIdentifier; const {%H-}ARight: TKilogramMeterPerSecondIdentifier): TMeterIdentifier; inline;
operator *(const {%H-}ALeft: TMeterIdentifier; const {%H-}ARight: TKilogramMeterPerSecondIdentifier): TKilogramSquareMeterPerSecondIdentifier; inline;
operator /(const {%H-}ALeft: TKilogramSquareMeterPerSecondIdentifier; const {%H-}ARight: TMeterIdentifier): TKilogramMeterPerSecondIdentifier; inline;
...
// alternative definition [ C2/N/m2 ] = [ F ] / [ m ]
operator /(const {%H-}ALeft: TFaradIdentifier; const {%H-}ARight: TMeterIdentifier): TSquareCoulombPerNewtonPerSquareMeterIdentifier; inline;
operator /(const {%H-}ALeft: TFaradIdentifier; const {%H-}ARight: TSquareCoulombPerNewtonPerSquareMeterIdentifier): TMeterIdentifier; inline;
operator *(const {%H-}ALeft: TSquareCoulombPerNewtonPerSquareMeterIdentifier; const {%H-}ARight: TMeterIdentifier): TFaradIdentifier; inline;
operator *(const {%H-}ALeft: TMeterIdentifier; const {%H-}ARight: TSquareCoulombPerNewtonPerSquareMeterIdentifier): TFaradIdentifier; inline;
...
operator *(const {%H-}ALeft: TAmpereIdentifier; const {%H-}ARight: TSquareMeterIdentifier): TAmpereSquareMeterIdentifier; inline;
operator /(const {%H-}ALeft: TAmpereSquareMeterIdentifier; const {%H-}ARight: TAmpereIdentifier): TSquareMeterIdentifier; inline;
operator *(const {%H-}ALeft: TSquareMeterIdentifier; const {%H-}ARight: TAmpereIdentifier): TAmpereSquareMeterIdentifier; inline;
operator /(const {%H-}ALeft: TAmpereSquareMeterIdentifier; const {%H-}ARight: TSquareMeterIdentifier): TAmpereIdentifier; inline;

// alternative definition [ A*m2 ] = [ N*m ] / [ T ]
operator /(const {%H-}ALeft: TNewtonMeterIdentifier; const {%H-}ARight: TTeslaIdentifier): TAmpereSquareMeterIdentifier; inline;
operator /(const {%H-}ALeft: TNewtonMeterIdentifier; const {%H-}ARight: TAmpereSquareMeterIdentifier): TTeslaIdentifier; inline;
operator *(const {%H-}ALeft: TAmpereSquareMeterIdentifier; const {%H-}ARight: TTeslaIdentifier): TNewtonMeterIdentifier; inline;
operator *(const {%H-}ALeft: TTeslaIdentifier; const {%H-}ARight: TAmpereSquareMeterIdentifier): TNewtonMeterIdentifier; inline;
...
// main definition [ kg*m ] = [ kg ] * [ m ]
operator *(const ALeft: TKilograms; const ARight: TMeters): TKilogramsMeter; inline;
operator /(const ALeft: TKilogramsMeter; const ARight: TKilograms): TMeters; inline;
operator *(const ALeft: TMeters; const ARight: TKilograms): TKilogramsMeter; inline;
operator /(const ALeft: TKilogramsMeter; const ARight: TMeters): TKilograms; inline;
...
// alternative definition [ kg*m2 ] = [ kg*m ] * [ m ]
operator *(const ALeft: TKilogramsMeter; const ARight: TMeters): TKilogramsSquareMeter; inline;
operator /(const ALeft: TKilogramsSquareMeter; const ARight: TKilogramsMeter): TMeters; inline;
operator *(const ALeft: TMeters; const ARight: TKilogramsMeter): TKilogramsSquareMeter; inline;
operator /(const ALeft: TKilogramsSquareMeter; const ARight: TMeters): TKilogramsMeter; inline;
...
// main definition [ N*m ] = [ kg*m2 ] * [ rad/s2 ]
operator *(const ALeft: TKilogramsSquareMeter; const ARight: TRadiansPerSquareSecond): TNewtonsMeter; inline;
operator /(const ALeft: TNewtonsMeter; const ARight: TKilogramsSquareMeter): TRadiansPerSquareSecond; inline;
operator *(const ALeft: TRadiansPerSquareSecond; const ARight: TKilogramsSquareMeter): TNewtonsMeter; inline;
operator /(const ALeft: TNewtonsMeter; const ARight: TRadiansPerSquareSecond): TKilogramsSquareMeter; inline;
...
// main definition [ kg*m2/s ] = [ kg*m/s ] * [ m ]
operator *(const ALeft: TKilogramsMeterPerSecond; const ARight: TMeters): TKilogramsSquareMeterPerSecond; inline;
operator /(const ALeft: TKilogramsSquareMeterPerSecond; const ARight: TKilogramsMeterPerSecond): TMeters; inline;
operator *(const ALeft: TMeters; const ARight: TKilogramsMeterPerSecond): TKilogramsSquareMeterPerSecond; inline;
operator /(const ALeft: TKilogramsSquareMeterPerSecond; const ARight: TMeters): TKilogramsMeterPerSecond; inline;

// alternative definition [ kg*m2/s ] = [ kg*m2 ] * [ rad/s ]
operator *(const ALeft: TKilogramsSquareMeter; const ARight: TRadiansPerSecond): TKilogramsSquareMeterPerSecond; inline;
operator /(const ALeft: TKilogramsSquareMeterPerSecond; const ARight: TKilogramsSquareMeter): TRadiansPerSecond; inline;
...
// alternative definition [ C2/N/m2 ] = [ F ] / [ m ]
operator /(const ALeft: TFarads; const ARight: TMeters): TSquareCoulombsPerNewtonPerSquareMeter; inline;
operator /(const ALeft: TFarads; const ARight: TSquareCoulombsPerNewtonPerSquareMeter): TMeters; inline;
operator *(const ALeft: TSquareCoulombsPerNewtonPerSquareMeter; const ARight: TMeters): TFarads; inline;
operator *(const ALeft: TMeters; const ARight: TSquareCoulombsPerNewtonPerSquareMeter): TFarads; inline;
...
// main definition [ A*m2 ] = [ A ] * [ m2 ]
operator *(const ALeft: TAmperes; const ARight: TSquareMeters): TAmperesSquareMeter; inline;
operator /(const ALeft: TAmperesSquareMeter; const ARight: TAmperes): TSquareMeters; inline;
operator *(const ALeft: TSquareMeters; const ARight: TAmperes): TAmperesSquareMeter; inline;
operator /(const ALeft: TAmperesSquareMeter; const ARight: TSquareMeters): TAmperes; inline;

// alternative definition [ A*m2 ] = [ N*m ] / [ T ]
operator /(const ALeft: TNewtonsMeter; const ARight: TTeslas): TAmperesSquareMeter; inline;
operator /(const ALeft: TNewtonsMeter; const ARight: TAmperesSquareMeter): TTeslas; inline;
operator *(const ALeft: TAmperesSquareMeter; const ARight: TTeslas): TNewtonsMeter; inline;
operator *(const ALeft: TTeslas; const ARight: TAmperesSquareMeter): TNewtonsMeter; inline;
...
{ Unit of TKilogramMeterUnit }

class function TKilogramMeterUnit.Symbol: string;
begin
  result := 'kg·m';
end;

class function TKilogramMeterUnit.Name: string;
begin
  result := 'kilogram meter';
end;
...
{ Unit of TAmpereSquareMeterUnit }

class function TAmpereSquareMeterUnit.Symbol: string;
begin
  result := 'A·m2';
end;

class function TAmpereSquareMeterUnit.Name: string;
begin
  result := 'ampere square meter';
end;
...
// main definition [ kg*m ] = [ kg ] * [ m ]
operator *(const ALeft: TKilogramIdentifier; const ARight: TMeterIdentifier): TKilogramMeterIdentifier;
begin end;

operator /(const ALeft: TKilogramMeterIdentifier; const ARight: TKilogramIdentifier): TMeterIdentifier;
begin end;

operator *(const ALeft: TMeterIdentifier; const ARight: TKilogramIdentifier): TKilogramMeterIdentifier;
begin end;

operator /(const ALeft: TKilogramMeterIdentifier; const ARight: TMeterIdentifier): TKilogramIdentifier;
begin end;
...
// alternative definition [ kg*m2 ] = [ kg*m ] * [ m ]
operator *(const ALeft: TKilogramMeterIdentifier; const ARight: TMeterIdentifier): TKilogramSquareMeterIdentifier;
begin end;

operator /(const ALeft: TKilogramSquareMeterIdentifier; const ARight: TKilogramMeterIdentifier): TMeterIdentifier;
begin end;

operator *(const ALeft: TMeterIdentifier; const ARight: TKilogramMeterIdentifier): TKilogramSquareMeterIdentifier;
begin end;

operator /(const ALeft: TKilogramSquareMeterIdentifier; const ARight: TMeterIdentifier): TKilogramMeterIdentifier;
begin end;
...
// main definition [ N*m ] = [ kg*m2 ] * [ rad/s2 ]
operator *(const ALeft: TKilogramSquareMeterIdentifier; const ARight: TRadianPerSquareSecondIdentifier): TNewtonMeterIdentifier;
begin end;

operator /(const ALeft: TNewtonMeterIdentifier; const ARight: TKilogramSquareMeterIdentifier): TRadianPerSquareSecondIdentifier;
begin end;

operator *(const ALeft: TRadianPerSquareSecondIdentifier; const ARight: TKilogramSquareMeterIdentifier): TNewtonMeterIdentifier;
begin end;

operator /(const ALeft: TNewtonMeterIdentifier; const ARight: TRadianPerSquareSecondIdentifier): TKilogramSquareMeterIdentifier;
begin end;
...
// main definition [ kg*m2/s ] = [ kg*m/s ] * [ m ]
operator *(const ALeft: TKilogramMeterPerSecondIdentifier; const ARight: TMeterIdentifier): TKilogramSquareMeterPerSecondIdentifier;
begin end;

operator /(const ALeft: TKilogramSquareMeterPerSecondIdentifier; const ARight: TKilogramMeterPerSecondIdentifier): TMeterIdentifier;
begin end;

operator *(const ALeft: TMeterIdentifier; const ARight: TKilogramMeterPerSecondIdentifier): TKilogramSquareMeterPerSecondIdentifier;
begin end;

operator /(const ALeft: TKilogramSquareMeterPerSecondIdentifier; const ARight: TMeterIdentifier): TKilogramMeterPerSecondIdentifier;
begin end;
...
// alternative definition [ C2/N/m2 ] = [ F ] / [ m ]
operator /(const ALeft: TFaradIdentifier; const ARight: TMeterIdentifier): TSquareCoulombPerNewtonPerSquareMeterIdentifier;
begin end;

operator /(const ALeft: TFaradIdentifier; const ARight: TSquareCoulombPerNewtonPerSquareMeterIdentifier): TMeterIdentifier;
begin end;

operator *(const ALeft: TSquareCoulombPerNewtonPerSquareMeterIdentifier; const ARight: TMeterIdentifier): TFaradIdentifier;
begin end;

operator *(const ALeft: TMeterIdentifier; const ARight: TSquareCoulombPerNewtonPerSquareMeterIdentifier): TFaradIdentifier;
begin end;
...
// main definition [ A*m2 ] = [ A ] * [ m2 ]
operator *(const ALeft: TAmpereIdentifier; const ARight: TSquareMeterIdentifier): TAmpereSquareMeterIdentifier;
begin end;

operator /(const ALeft: TAmpereSquareMeterIdentifier; const ARight: TAmpereIdentifier): TSquareMeterIdentifier;
begin end;

operator *(const ALeft: TSquareMeterIdentifier; const ARight: TAmpereIdentifier): TAmpereSquareMeterIdentifier;
begin end;

operator /(const ALeft: TAmpereSquareMeterIdentifier; const ARight: TSquareMeterIdentifier): TAmpereIdentifier;
begin end;

// alternative definition [ A*m2 ] = [ N*m ] / [ T ]
operator /(const ALeft: TNewtonMeterIdentifier; const ARight: TTeslaIdentifier): TAmpereSquareMeterIdentifier;
begin end;

operator /(const ALeft: TNewtonMeterIdentifier; const ARight: TAmpereSquareMeterIdentifier): TTeslaIdentifier;
begin end;

operator *(const ALeft: TAmpereSquareMeterIdentifier; const ARight: TTeslaIdentifier): TNewtonMeterIdentifier;
begin end;

operator *(const ALeft: TTeslaIdentifier; const ARight: TAmpereSquareMeterIdentifier): TNewtonMeterIdentifier;
begin end;
...
// main definition [ kg*m ] = [ kg ] * [ m ]
operator *(const ALeft: TKilograms; const ARight: TMeters): TKilogramsMeter;
begin
  result.Value := ALeft.Value * ARight.Value;
end;

operator /(const ALeft: TKilogramsMeter; const ARight: TKilograms): TMeters;
begin
  result.Value := ALeft.Value / ARight.Value;
end;

operator *(const ALeft: TMeters; const ARight: TKilograms): TKilogramsMeter;
begin
  result.Value := ALeft.Value * ARight.Value;
end;

operator /(const ALeft: TKilogramsMeter; const ARight: TMeters): TKilograms;
begin
  result.Value := ALeft.Value / ARight.Value;
end;
...
// alternative definition [ kg*m2 ] = [ kg*m ] * [ m ]
operator *(const ALeft: TKilogramsMeter; const ARight: TMeters): TKilogramsSquareMeter;
begin
  result.Value := ALeft.Value * ARight.Value;
end;

operator /(const ALeft: TKilogramsSquareMeter; const ARight: TKilogramsMeter): TMeters;
begin
  result.Value := ALeft.Value / ARight.Value;
end;

operator *(const ALeft: TMeters; const ARight: TKilogramsMeter): TKilogramsSquareMeter;
begin
  result.Value := ALeft.Value * ARight.Value;
end;

operator /(const ALeft: TKilogramsSquareMeter; const ARight: TMeters): TKilogramsMeter;
begin
  result.Value := ALeft.Value / ARight.Value;
end;
...
// main definition [ N*m ] = [ kg*m2 ] * [ rad/s2 ]
operator *(const ALeft: TKilogramsSquareMeter; const ARight: TRadiansPerSquareSecond): TNewtonsMeter;
begin
  result.Value := ALeft.Value * ARight.Value;
end;

operator /(const ALeft: TNewtonsMeter; const ARight: TKilogramsSquareMeter): TRadiansPerSquareSecond;
begin
  result.Value := ALeft.Value / ARight.Value;
end;

operator *(const ALeft: TRadiansPerSquareSecond; const ARight: TKilogramsSquareMeter): TNewtonsMeter;
begin
  result.Value := ALeft.Value * ARight.Value;
end;

operator /(const ALeft: TNewtonsMeter; const ARight: TRadiansPerSquareSecond): TKilogramsSquareMeter;
begin
  result.Value := ALeft.Value / ARight.Value;
end;
...
// main definition [ kg*m2/s ] = [ kg*m/s ] * [ m ]
operator *(const ALeft: TKilogramsMeterPerSecond; const ARight: TMeters): TKilogramsSquareMeterPerSecond;
begin
  result.Value := ALeft.Value * ARight.Value;
end;

operator /(const ALeft: TKilogramsSquareMeterPerSecond; const ARight: TKilogramsMeterPerSecond): TMeters;
begin
  result.Value := ALeft.Value / ARight.Value;
end;

operator *(const ALeft: TMeters; const ARight: TKilogramsMeterPerSecond): TKilogramsSquareMeterPerSecond;
begin
  result.Value := ALeft.Value * ARight.Value;
end;

operator /(const ALeft: TKilogramsSquareMeterPerSecond; const ARight: TMeters): TKilogramsMeterPerSecond;
begin
  result.Value := ALeft.Value / ARight.Value;
end;

// alternative definition [ kg*m2/s ] = [ kg*m2 ] * [ rad/s ]
operator *(const ALeft: TKilogramsSquareMeter; const ARight: TRadiansPerSecond): TKilogramsSquareMeterPerSecond;
begin
  result.Value := ALeft.Value * ARight.Value;
end;

operator /(const ALeft: TKilogramsSquareMeterPerSecond; const ARight: TKilogramsSquareMeter): TRadiansPerSecond;
begin
  result.Value := ALeft.Value / ARight.Value;
end;

operator *(const ALeft: TRadiansPerSecond; const ARight: TKilogramsSquareMeter): TKilogramsSquareMeterPerSecond;
begin
  result.Value := ALeft.Value * ARight.Value;
end;

operator /(const ALeft: TKilogramsSquareMeterPerSecond; const ARight: TRadiansPerSecond): TKilogramsSquareMeter;
begin
  result.Value := ALeft.Value / ARight.Value;
end;
...
// alternative definition [ C2/N/m2 ] = [ F ] / [ m ]
operator /(const ALeft: TFarads; const ARight: TMeters): TSquareCoulombsPerNewtonPerSquareMeter;
begin
  result.Value := ALeft.Value / ARight.Value;
end;

operator /(const ALeft: TFarads; const ARight: TSquareCoulombsPerNewtonPerSquareMeter): TMeters;
begin
  result.Value := ALeft.Value / ARight.Value;
end;

operator *(const ALeft: TSquareCoulombsPerNewtonPerSquareMeter; const ARight: TMeters): TFarads;
begin
  result.Value := ALeft.Value * ARight.Value;
end;

operator *(const ALeft: TMeters; const ARight: TSquareCoulombsPerNewtonPerSquareMeter): TFarads;
begin
  result.Value := ALeft.Value * ARight.Value;
end;
...
// main definition [ A*m2 ] = [ A ] * [ m2 ]
operator *(const ALeft: TAmperes; const ARight: TSquareMeters): TAmperesSquareMeter;
begin
  result.Value := ALeft.Value * ARight.Value;
end;

operator /(const ALeft: TAmperesSquareMeter; const ARight: TAmperes): TSquareMeters;
begin
  result.Value := ALeft.Value / ARight.Value;
end;

operator *(const ALeft: TSquareMeters; const ARight: TAmperes): TAmperesSquareMeter;
begin
  result.Value := ALeft.Value * ARight.Value;
end;

operator /(const ALeft: TAmperesSquareMeter; const ARight: TSquareMeters): TAmperes;
begin
  result.Value := ALeft.Value / ARight.Value;
end;

// alternative definition [ A*m2 ] = [ N*m ] / [ T ]
operator /(const ALeft: TNewtonsMeter; const ARight: TTeslas): TAmperesSquareMeter;
begin
  result.Value := ALeft.Value / ARight.Value;
end;

operator /(const ALeft: TNewtonsMeter; const ARight: TAmperesSquareMeter): TTeslas;
begin
  result.Value := ALeft.Value / ARight.Value;
end;

operator *(const ALeft: TAmperesSquareMeter; const ARight: TTeslas): TNewtonsMeter;
begin
  result.Value := ALeft.Value * ARight.Value;
end;

operator *(const ALeft: TTeslas; const ARight: TAmperesSquareMeter): TNewtonsMeter;
begin
  result.Value := ALeft.Value * ARight.Value;
end;
...
operator := (AQuantity: TTeslasMeterPerAmpere): THenrysPerMeter;
begin
  result.Value := AQuantity.Value;
end;
