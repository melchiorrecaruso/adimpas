...
{
  ADimPas library built on 15/10/2023.
...
{$DEFINE INTF_QUANTITY}{$DEFINE TQuantity:=TMeterPerSecondSquaredQty}{$i adim.inc}
  ...
  class operator /(const ALeft: TMeterPerSecondSquaredQty; const ARight: TMeterQty): TSquareHertzQty;
...
{$DEFINE INTF_QUANTITY}{$DEFINE TQuantity:=TSquareMeterPerSquareSecondQty}{$i adim.inc}
  class operator /(const ALeft: TJouleQty; const ARight: TSquareMeterPerSquareSecondQty): TKilogramQty;
  ...
  class operator /(const ALeft: TSquareMeterPerSquareSecondQty; const ARight: TMeterQty): TMeterPerSecondSquaredQty;
...
{$DEFINE INTF_QUANTITY}{$DEFINE TQuantity:=TSecondQty}{$i adim.inc}
  ...
  class operator /(const ALeft: THertzQty; const ARight: TSecondQty): TSquareHertzQty;
...
{$DEFINE INTF_QUANTITY}{$DEFINE TQuantity:=TMeterPerSecondQty}{$i adim.inc}
  ...
  class operator /(const ALeft: TMeterPerSecondQty; const ARight: TSecondQty): TMeterPerSecondSquaredQty;
...
operator /(const ALeft: THertzQty; const ARight: TSquareHertzQty): TSecondQty;
...
operator *(const ALeft: TSecondQty; const ARight: TMeterPerSecondSquaredQty): TMeterPerSecondQty;
operator *(const ALeft: TMeterPerSecondSquaredQty; const ARight: TSecondQty): TMeterPerSecondQty;
...
operator *(const ALeft: TMeterQty; const ARight: TKilogramPerCubicMeterQty): TKilogramPerSquareMeterQty;
operator *(const ALeft: TKilogramPerCubicMeterQty; const ARight: TMeterQty): TKilogramPerSquareMeterQty;
...
operator *(const ALeft: TFaradQty; const ARight: TOhmQty): TSecondQty;
operator *(const ALeft: TOhmQty; const ARight: TFaradQty): TSecondQty;
...
class operator TSecondQty./(const ALeft: THertzQty; const ARight: TSecondQty): TSquareHertzQty;
begin
  result.FValue := ALeft.FValue / ARight.FValue;
end;

class operator TSecondQty.*(const ALeft: TSecondQty; const ARight: TSquareHertzQty): THertzQty;
begin
  result.FValue := ALeft.FValue * ARight.FValue;
end;

class operator TSecondQty.*(const ALeft: TSquareHertzQty; const ARight: TSecondQty): THertzQty;
begin
  result.FValue := ALeft.FValue * ARight.FValue;
end;
...
class operator TMeterPerSecondQty./(const ALeft: TMeterPerSecondQty; const ARight: TSecondQty): TMeterPerSecondSquaredQty;
begin
  result.FValue := ALeft.FValue / ARight.FValue;
end;
...
class operator TMeterPerSecondQty./(const ALeft: TMeterPerSecondQty; const ARight: TMeterPerSecondSquaredQty): TSecondQty;
begin
  result.FValue := ALeft.FValue / ARight.FValue;
end;
...
class operator TKilogramPerSquareMeterQty./(const ALeft: TKilogramPerSquareMeterQty; const ARight: TMeterQty): TKilogramPerCubicMeterQty;
begin
  result.FValue := ALeft.FValue / ARight.FValue;
end;
...
class operator TKilogramPerSquareMeterQty./(const ALeft: TKilogramPerSquareMeterQty; const ARight: TKilogramPerCubicMeterQty): TMeterQty;
begin
  result.FValue := ALeft.FValue / ARight.FValue;
end;
...
class operator TSecondQty./(const ALeft: TSecondQty; const ARight: TFaradQty): TOhmQty;
begin
  result.FValue := ALeft.FValue / ARight.FValue;
end;
...
class operator TSecondQty./(const ALeft: TSecondQty; const ARight: TOhmQty): TFaradQty;
begin
  result.FValue := ALeft.FValue / ARight.FValue;
end;
